...
- Linux AppImage single-instance/focus-loop recovery notes for desktop launcher regressions. See [Linux AppImage Single-Instance Focus Loop](./linux-appimage-single-instance-focus-loop.md).
