...
**Cause:** `design-preview-approved.html` was never created. Either the ui-design-handoff workflow was not completed, or the file was created with the wrong name (`design-preview.html` instead of `design-preview-approved.html`).
...
- [ ] Check whether the ui-design-handoff workflow was skipped in this spec's delivery

**Recovery — path A (ui-design-handoff workflow was run, file has wrong name):**
